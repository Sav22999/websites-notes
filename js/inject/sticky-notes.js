...
function createNew(notes, x = "10px", y = "10px", w = "200px", h = "300px", opacity = 0.7, websites_json, settings_json) {
    if (!document.getElementById("sticky-notes-notefox-addon")) {
        ...
        document.head.innerHTML += getCSS(notes, x, y, w, h, opacity, websites_json, settings_json);
...
function getCSS(notes, x = "10px", y = "10px", w = "200px", h = "300px", opacity = 0.7, websites_json, settings_json) {
    ...
    if (settings_json !== undefined && settings_json["disable-word-wrap"] !== undefined) {
        if (settings_json["disable-word-wrap"] === "yes") disable_word_wrap = true;
        else disable_word_wrap = false;
    }
    let disable_word_wrap_css_to_show = "";
    if (disable_word_wrap) {
        disable_word_wrap_css_to_show = "#sticky-notes-notefox-addon * {white-space: none;}";
    } else {
        disable_word_wrap_css_to_show = "#sticky-notes-notefox-addon * {white-space: pre-wrap;}";
    }
