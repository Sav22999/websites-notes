...
function getIconSvgEncoded(icon, color) {
    ...
    switch (icon) {
        ...
        case "sticky-restore":
            ...
            break;
        case "bold":
            svgToReturn = '<svg width="100%" height="100%" viewBox="0 0 800 800" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">\n' +
                '    <g>\n' +
                '        <g id="Editor">\n' +
                '            <g id="bold_fill">\n' +
        ...
        case "italic":
            svgToReturn = '<svg width="800px" height="800px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\n' +
                ...
                '        <g id="Editor" transform="translate(-672.000000, -48.000000)" fill-rule="nonzero">\n' +
                '            <g id="italic_fill" transform="translate(672.000000, 48.000000)">\n' +
        ...
        case "underline":
            svgToReturn = '<svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
                '    <path d="M7 4V11C7 13.7614 9.23858 16 12 16C14.7614 16 17 13.7614 17 11V4" stroke="' + color + '" stroke-width="2"\n' +
                '          stroke-linecap="round"/>\n' +
                '    <path d="M5 20H19" stroke="' + color + '" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>\n' +
                '</svg>';
            break;
        case "strikethrough":
            svgToReturn = '<svg width="100%" height="100%" viewBox="0 0 800 800" version="1.1" xmlns="http://www.w3.org/2000/svg"\n' +
                ...
                '          style="fill-rule:nonzero;stroke:' + color + ';stroke-width:20px;"/>\n' +
                '</svg>';
            break;
        case "align-center":
            svgToReturn = '<svg width="800px" height="800px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\n' +
        ...
        case "spellcheck_sel":
            svgToReturn = '<svg width="100%" height="100%" viewBox="0 0 800 800" version="1.1" xmlns="http://www.w3.org/2000/svg"\n' +
                ...
                '              style="fill:' + color + ';fill-rule:nonzero;stroke:' + color + ';stroke-width:30px;"/>\n' +
                '    </g>\n' +
                '</svg>';
            break;
        /*
