    ...
    switch (icon) {
        ...
        case "telegram":
            svgToReturn =
                '<svg fill="' +
                color +
                '" width="800px" height="800px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">\n' +
        ...
        case "redo":
            svgToReturn =
                ...
                '                <path d="M24,0 L24,24 L0,24 L0,0 L24,0 Z M12.5934901,23.257841 L12.5819402,23.2595131 L12.5108777,23.2950439 L12.4918791,23.2987469 L12.4918791,23.2987469 L12.4767152,23.2950439 L12.4056548,23.2595131 C12.3958229,23.2563662 12.3870493,23.2590235 12.3821421,23.2649074 L12.3780323,23.275831 L12.360941,23.7031097 L12.3658947,23.7234994 L12.3769048,23.7357139 L12.4804777,23.8096931 L12.4953491,23.8136134 L12.4953491,23.8136134 L12.5071152,23.8096931 L12.6106902,23.7357139 L12.6232938,23.7196733 L12.6232938,23.7196733 L12.6266527,23.7031097 L12.609561,23.275831 C12.6075724,23.2657013 12.6010112,23.2592993 12.5934901,23.257841 L12.5934901,23.257841 Z M12.8583906,23.1452862 L12.8445485,23.1473072 L12.6598443,23.2396597 L12.6498822,23.2499052 L12.6498822,23.2499052 L12.6471943,23.2611114 L12.6650943,23.6906389 L12.6699349,23.7034178 L12.6699349,23.7034178 L12.678386,23.7104931 L12.8793402,23.8032389 C12.8914285,23.8068999 12.9022333,23.8029875 12.9078286,23.7952264 L12.9118235,23.7811639 L12.8776777,23.1665331 C12.8752882,23.1545897 12.8674102,23.1470016 12.8583906,23.1452862 L12.8583906,23.1452862 Z M12.1430473,23.1473072 C12.1332178,23.1423925 12.1221763,23.1452606 12.1156365,23.1525954 L12.1099173,23.1665331 L12.0757714,23.7811639 C12.0751323,23.7926639 12.0828099,23.8018602 12.0926481,23.8045676 L12.108256,23.8032389 L12.3092106,23.7104931 L12.3186497,23.7024347 L12.3186497,23.7024347 L12.3225043,23.6906389 L12.340401,23.2611114 L12.337245,23.2485176 L12.337245,23.2485176 L12.3277531,23.2396597 L12.1430473,23.1473072 Z" id="MingCute" fill-rule="nonzero">\n' +
                "</path>\n" +
                '                <path d="M16.8392,10.9724 C15.5546,9.45943 13.6384,8.5 11.5,8.5 C7.63401,8.5 4.5,11.634 4.5,15.5 C4.5,16.3284 3.82843,17 3,17 C2.17157,17 1.5,16.3284 1.5,15.5 C1.5,9.97715 5.97715,5.5 11.5,5.5 C14.4439,5.5 17.0891,6.77161 18.9184,8.79452 L19.2647,6.83068 C19.4085,6.01484 20.1865,5.47009 21.0024,5.61394 C21.8182,5.7578 22.363,6.53578 22.2191,7.35163 L21.1772,13.2605 C21.1081,13.6523 20.8863,14.0005 20.5604,14.2287 C20.1571,14.5111 19.6264,14.5736 19.1747,14.4305 L13.5307,13.4353 C12.7149,13.2915 12.1701,12.5135 12.314,11.6976 C12.4578,10.8818 13.2358,10.337 14.0516,10.4809 L16.8392,10.9724 Z" fill="' +
                color +
                '">\n' +
                "</path>\n" +
                "            </g>\n" +
        ...
        case "spellcheck_sel":
            svgToReturn =
                '<svg fill="' +
                color +
                '" width="800px" height="800px" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">\n' +
        ...
        case "website":
            svgToReturn =
                "" +
                '<svg fill="none" height="800" stroke="' +
                color +
                '" stroke-width="3" viewBox="0 0 64 64" width="800"\n' +
        ...
        case "login":
            svgToReturn =
                '<svg fill="' +
                color +
                '" height="800" viewBox="0 0 24 24" width="800" xmlns="http://www.w3.org/2000/svg">\n' +
                "    <g>\n" +
        ...
        case "sync":
            svgToReturn =
                '<svg height="800" viewBox="0 0 48 48" width="800" xmlns="http://www.w3.org/2000/svg">\n' +
        ...
        case "sync-error":
            svgToReturn =
                ...
                '    <path fill="' +
                color +
                '" d="m24 28a2 2 0 0 0 2-2v-10a2 2 0 0 0 -4 0v10a2 2 0 0 0 2 2z"/>\n' +
                '    <circle fill="' +
                color +
                '" cx="24" cy="32" r="2"/>\n' +
                "</svg>";
        ...
        case "code":
            svgToReturn =
                '<svg fill="' +
                color +
                '" height="800" viewBox="0 0 512 512" width="800" xmlns="http://www.w3.org/2000/svg">\n' +
        ...
        case "h1":
            svgToReturn =
                '<svg fill="' +
                color +
                '" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 800 800"\n' +
                '     xmlns="http://www.w3.org/2000/svg">\n' +
        ...
        case "h3":
            svgToReturn =
                '<svg fill="' +
                color +
                '" width="100%" height="100%" viewBox="0 0 800 800" version="1.1" xmlns="http://www.w3.org/2000/svg"\n' +
                '     style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">\n' +
                "    <g>\n" +
        ...
        case "h4":
            svgToReturn =
                '<svg fill="' +
                color +
                '" width="100%" height="100%" viewBox="0 0 800 800" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">\n' +
                "    <g>\n" +
                '        <rect x="0" y="0" width="800" height="800" style="fill:none;"/>\n' +
        ...
        case "edit":
            svgToReturn =
                '<svg fill="' +
                color +
                '" height="800" viewBox="0 -.5 21 21" width="800" xmlns="http://www.w3.org/2000/svg">\n' +
        ...
        case "finish-edit":
            svgToReturn =
                '<svg fill="' +
                color +
                '" height="800" viewBox="0 0 32 32" width="800" xmlns="http://www.w3.org/2000/svg">\n' +
        ...
        case "external-link":
            svgToReturn =
                '<svg fill="none" width="14px" height="14px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\n' +
                '    <g stroke="' +
                color +
