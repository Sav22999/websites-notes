...
strings[lang] = {
    ...
    "disable-sync-settings-message": "Due to some space limitation with sync I advise you to disable the data synced in this page. Otherwise, the add-on should not work properly anymore!<br>To do that, find {{property1}} and enable it.",
    "disable-sync-message": "Due to some space limitation with sync I advise you to disable the data synced in this page. Otherwise, the add-on should not work properly anymore!<br>To do that, in the add-on Settings find  {{property1}} and enable it.",
    ...
    "signing-up-text": "Signing up you'll accept the <a {{parameters1}}>Terms of Service</a> and <a {{parameters2}}>Privacy Policy</a>. Once you sign up, you'll receive an email to confirm your account. If you don't receive the email, check your spam folder. Pay attention to the password you choose: don't forget it because it's not possible to recover data because it's encrypted with an end-to-end encryption.",
    "logout-button": "Logout",
    "change-password-button": "Change password",
    "logout-all-devices-button": "Logout from all devices",
